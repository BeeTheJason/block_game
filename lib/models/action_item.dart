...
final List<Item> menuItems = [
  ...
  const Item(
      name: 'Light',
      uid: '1',
      backgroundColor: Color(0xFF6D70A6),
      borderColor: Color(0xFF7272C0),
      asset: CustomIcons.lightbulb_1,
      options: <Color>[Colors.red, Colors.yellow, Colors.blue, Colors.green],
      detailsBorderColor: const Color(0xFF8080D8),
      optionsBorderColor: const Color(0xFFDFD0F2),
      optionsDropDownColor: const Color(0xFFDFD0F2),
